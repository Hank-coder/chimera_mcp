...
class ChimeraFastMCPServer:
    ...
    def _setup_tools(self):
        ...
        @self.mcp.tool(
            title="关系与记忆搜索（统一图谱）",
            description=(
                    "这是一个统一的知识图谱搜索工具，用于检索社交关系和长期个人记忆。"
                    "可查找人际关系、项目参与、个人偏好和事件等信息。\n\n"
                    "**数据来源**：\n"
                    " - 聊天与协作记录：人际关系、群组成员、项目协作\n"
                    " - 个人记忆：通过工具添加的关系、偏好、事件\n\n"
                    "**适用场景**：\n"
                    " - 人名查询：例如 \"某某\"、\"张三\"\n"
                    " - 项目查询：例如 \"Alpha项目\"、\"Beta计划\"\n"
                    " - 关系查询：例如 \"谁参与了Alpha项目\"、\"我和张三是什么关系\"\n"
                    " - 偏好查询：例如 \"我喜欢什么\"、\"饮食偏好\"\n"
                    " - 事件查询：例如 \"我参与了哪些项目\"\n\n"
                    "**调用参数**（字段名区分大小写）：\n"
                    " - query (字符串，必填)：搜索关键词或问题\n"
